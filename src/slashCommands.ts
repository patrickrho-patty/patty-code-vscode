...
const commands: SlashCommand[] = [
  {
    names: ["help", "?"],
    description: "Show the built-in Mirr Code slash commands.",
    build: () => [
      "List the built-in Mirr Code VS Code slash commands and when to use them.",
      "",
  ...
  {
    names: ["skills", "skill"],
    description: "Use the appropriate available Mirr Code/Codex skills.",
    build: (args) => withRequest(
      "Use the appropriate Mirr Code/Codex skills for this request if they are available. State which skill is relevant and what it contributes.",
      args,
    ),
  },
];
